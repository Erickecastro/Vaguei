# Privacidade no Vaguei

Última atualização: 5 de setembro de 2026.

## Resumo

Na versão atual, currículos são processados localmente no dispositivo. O Vaguei não possui conta de usuário, backend próprio, telemetria ou upload de currículo.
...
O Vaguei não vende dados pessoais. Ao abrir uma vaga, o usuário deixa o aplicativo e passa a interagir com o site da empresa ou plataforma, sujeito à política de privacidade daquele serviço.
