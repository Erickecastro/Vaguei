...
public sealed class JobSearchTermGenerator
{
    ...
    private static readonly (Regex Pattern, string[] Variants)[]
        ...
        [
            ...
            (new Regex(@"\btrainee\b", RegexOptions.IgnoreCase | RegexOptions.CultureInvariant),
                ["trainee", "programa de trainee", "graduate program", "early careers", "entry level"]),
            (new Regex(@"\b(gerente|gestor[a]?|manager)\b", RegexOptions.IgnoreCase | RegexOptions.CultureInvariant),
                ["gerente", "manager", "gestor", "gestora", "management"]),
            (new Regex(@"\b(operador[a]?|operator)\b", RegexOptions.IgnoreCase | RegexOptions.CultureInvariant),
                ["operador", "operadora", "operator", "operador de produção", "production operator"]),
            (new Regex(@"\b(supervisor[a]?|supervisor)\b", RegexOptions.IgnoreCase | RegexOptions.CultureInvariant),
                ["supervisor", "supervisora", "supervision"]),
            (new Regex(@"\b(coordenador[a]?|coordinator)\b", RegexOptions.IgnoreCase | RegexOptions.CultureInvariant),
                ["coordenador", "coordenadora", "coordinator"]),
            (new Regex(@"\b(t[eé]cnico[a]?|technician)\b", RegexOptions.IgnoreCase | RegexOptions.CultureInvariant),
                ["técnico", "tecnico", "técnica", "tecnica", "technician"]),
